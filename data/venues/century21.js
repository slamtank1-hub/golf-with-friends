...
function centuryAssetPaths(courseKey, holeNo) {
  ...
  return {
    summaryImage: `assets/century21/${asset.folder}/${asset.prefix}summary_hole${holeNo}.png`,
    assets: {
...
const VALLEY_HOLES = [
  { no: 1, par: 4, back: "375y", regular: "354y", white: "354y", ladies: "303y", si: 9, feature: "출발 Par 4 · 계곡 지형 · 방향성", target: "첫 홀은 장타보다 공을 살리는 티샷. Regular 기준 354y라 무리하지 말고 페어웨이 중앙으로 80% 리듬을 만든다.", green: "첫 퍼트는 라인보다 거리감 확인. 짧은 퍼트를 남기는 쪽으로." },
  { no: 2, par: 4, back: "452y", regular: "386y", white: "386y", ladies: "337y", si: 5, feature: "긴 Par 4 · 수목 라인 · 세컨 부담", target: "Regular 기준 386y로 세컨이 남을 수 있다. 티샷은 넓은 쪽으로 보내고, 세컨은 핀보다 그린 중앙 또는 어프로치 쉬운 방향.", green: "핀을 바로 보지 말고 넓은 면에 올린 뒤 2퍼트 기준." },
  ...
  { no: 4, par: 5, back: "580y", regular: "467y", white: "467y", ladies: "401y", si: 1, feature: "핸디캡 홀 · Par 5 · 3샷 계획", target: "긴 Par 5는 무리한 2온보다 3샷 설계. 위험 구역 앞에서 끊고 편한 서드샷 거리를 남긴다.", green: "넓은 면에 올리는 것이 우선. 첫 퍼트는 거리감만 맞춰도 성공." },
  { no: 5, par: 3, back: "180y", regular: "138y", white: "138y", ladies: "103y", si: 2, feature: "Par 3 · 거리감 · 짧은 미스 주의", target: "핸디캡이 높은 파3. 짧은 미스보다 중앙까지 확실히 보내는 클럽 선택이 좋다.", green: "핀 하이보다 중앙. 3퍼트를 막는 속도 조절 우선." },
  { no: 6, par: 4, back: "360y", regular: "322y", white: "322y", ladies: "278y", si: 1, feature: "승부 Par 4 · 방향성 · 보기 방어", target: "티샷은 중앙 라인 유지. 위험 쪽 핀은 포기하고 세컨은 그린 중앙 또는 앞 안전 구역.", green: "착지 후 구르는 방향 확인. 내리막 퍼트가 남으면 보수적으로." },
  { no: 7, par: 4, back: "404y", regular: "385y", white: "385y", ladies: "301y", si: 7, feature: "긴 Par 4 · 페어웨이 우선 · 세컨 각도", target: "Regular 기준 385y로 거리 부담이 있다. 티샷 생존이 우선이고, 세컨은 핀보다 넓은 면을 본다.", green: "첫 퍼트 속도 우선. 보기 방어가 좋은 결과다." },
  { no: 8, par: 4, back: "447y", regular: "405y", white: "405y", ladies: "362y", si: 6, feature: "매우 긴 Par 4 · 큰 사고 방지 · 집중", target: "Regular 405y의 긴 홀. 무리한 장타보다 페어웨이 안착, 세컨은 짧아도 어프로치 쉬운 방향으로 보낸다.", green: "긴 퍼트가 남아도 괜찮다. 첫 퍼트는 홀 근처에 붙이는 생각." },
...
const FIELD_HOLES = [
  { no: 1, par: 4, back: "450y", regular: "343y", white: "343y", ladies: "304y", si: 9, feature: "출발 Par 4 · 개방감 · 페어웨이", target: "출발 홀은 페어웨이 중앙으로 단순하게. 넓어 보여도 첫 샷은 80% 리듬이 좋다.", green: "첫 퍼트는 거리감 확인. 다음 홀 기준 만들기." },
  { no: 2, par: 4, back: "384y", regular: "317y", white: "317y", ladies: "274y", si: 5, feature: "중간 Par 4 · 바람 · 방향성", target: "구질을 만들기보다 안정적인 방향. 세컨 각도가 좋은 페어웨이 쪽을 선택한다.", green: "핀보다 중앙. 옆 경사는 과하게 보지 않는다." },
  { no: 3, par: 5, back: "508y", regular: "459y", white: "459y", ladies: "420y", si: 4, feature: "Par 5 · 랜딩존 · 3샷 운영", target: "티샷은 페어웨이 우선. 세컨은 그린 욕심보다 좋은 서드샷 거리와 각도를 남긴다.", green: "넓은 면에 올리기. 첫 퍼트는 거리감 우선." },
  { no: 4, par: 3, back: "219y", regular: "143y", white: "143y", ladies: "131y", si: 6, feature: "Par 3 · 클럽 선택 · 짧은 미스 금지", target: "Regular 기준 143y. 핀보다 그린 중앙을 기준으로 하고, 앞쪽 위험은 확실히 넘긴다.", green: "핀보다 중앙. 2퍼트만 해도 좋은 결과." },
  { no: 5, par: 4, back: "338y", regular: "307y", white: "307y", ladies: "260y", si: 3, feature: "전략 Par 4 · 벙커 회피 · 세컨 정확도", target: "짧아 보여도 벙커와 러프 방향 미스를 줄이는 홀. 티샷은 중앙, 세컨은 핀보다 안전 면.", green: "첫 퍼트 속도. 짧은 퍼트 남기는 위치가 좋다." },
  { no: 6, par: 3, back: "157y", regular: "136y", white: "136y", ladies: "74y", si: 8, feature: "짧은 Par 3 · 경사 확인 · 중앙", target: "거리 욕심보다 중앙 온그린. 바람이 있으면 클럽을 보수적으로 잡는다.", green: "굴러가는 방향 체크. 내리막 퍼트는 짧게 남긴다." },
  { no: 7, par: 4, back: "373y", regular: "343y", white: "343y", ladies: "206y", si: 7, feature: "후반 Par 4 · 방향성 · 세컨 각도", target: "페어웨이 중앙. 다음 샷 각도를 확보하는 티샷이 가장 중요하다.", green: "오르막 퍼트가 남는 쪽 선호. 무리한 핀 공략 금지." },
  { no: 8, par: 5, back: "595y", regular: "502y", white: "502y", ladies: "455y", si: 1, feature: "핸디캡 홀 · 긴 Par 5 · 거리 배분", target: "가장 긴 축의 Par 5. 장타보다 3샷 계획, 세컨은 위험 구역을 피하는 레이업이 핵심.", green: "핀보다 중앙. 올리고 2퍼트면 충분하다." },
  { no: 9, par: 4, back: "506y", regular: "467y", white: "467y", ladies: "414y", si: 2, feature: "마무리 장거리 Par 4 · 보기 방어 · 페어웨이", target: "Regular 467y로 매우 긴 마무리 홀. 티샷은 생존, 세컨은 그린 주변 안전 구역까지 보내는 생각이 현실적이다.", green: "롱퍼트가 남아도 괜찮다. 첫 퍼트는 짧지 않게." }
];

const LAKE_HOLES = [
  { no: 1, par: 4, back: "461y", regular: "402y", white: "402y", ladies: "384y", si: 6, feature: "레이크 시작 · 물 의식 · 긴 Par 4", target: "첫 홀부터 Regular 402y로 길다. 물을 의식해 힘이 들어가지 않게 중앙 라인으로 출발한다.", green: "첫 퍼트 거리감. 무리한 버디보다 파/보기 방어." },
  { no: 2, par: 5, back: "581y", regular: "529y", white: "529y", ladies: "518y", si: 2, feature: "긴 Par 5 · 3샷 계획 · 세컨 욕심 금지", target: "티샷은 넓은 쪽, 세컨은 안전한 거리. 긴 홀이라 한 번에 만회하려는 샷을 피한다.", green: "중앙에 올리고 2퍼트. 서드샷 거리감이 핵심." },
  ...
  { no: 7, par: 5, back: "527y", regular: "515y", white: "515y", ladies: "498y", si: 1, feature: "핸디캡 홀 · 긴 전장 · 인내", target: "Regular 515y의 긴 Par 5. 위험 구역을 피하고 다음 샷 거리를 남기는 운영이 좋다.", green: "올리면 성공, 2퍼트 기준. 핀보다 중앙." },
...
const PINE_HOLES = [
  { no: 1, par: 4, back: "399y", regular: "324y", white: "324y", ladies: "319y", si: 9, feature: "회원제 코스 출발 · 수목 · 방향성", target: "첫 홀은 방향성 우선. 페어웨이 중앙으로 80% 리듬을 만든다.", green: "거리감 확인. 첫 퍼트는 넣기보다 붙이기." },
  { no: 2, par: 3, back: "208y", regular: "162y", white: "162y", ladies: "153y", si: 6, feature: "Par 3 · 거리감 · 바람", target: "Regular 162y의 부담 있는 파3. 핀보다 그린 넓은 면을 보고 짧은 미스를 피한다.", green: "속도 우선. 롱퍼트면 2퍼트 기준." },
  ...
  { no: 5, par: 4, back: "470y", regular: "430y", white: "430y", ladies: "425y", si: 1, feature: "핸디캡 홀 · 긴 Par 4 · 보기 방어", target: "Regular 430y의 매우 긴 Par 4. 티샷 생존이 최우선이고, 세컨은 그린 앞 안전 구역까지 보내도 좋다.", green: "2퍼트 기준. 긴 퍼트는 거리만 맞춘다." },
  ...
  { no: 7, par: 5, back: "510y", regular: "440y", white: "440y", ladies: "420y", si: 7, feature: "Par 5 · 후반 집중 · 레이업", target: "무리한 2온보다 좋은 서드샷 거리 만들기. 페어웨이 중앙을 지키면 기회가 온다.", green: "첫 퍼트 속도. 핀보다 중앙이 안전하다." },
